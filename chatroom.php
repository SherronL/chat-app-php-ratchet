...
<html>
<head>
	<title>Chat App with Ratchet</title>
...
<body>
	<div class="container">
		<h2 class="text-center" style="margin-top: 5px; padding-top: 0;">Chat App with Ratchet</h2>
		<hr>
		<div class="row">
			<div class="col-md-4">
				<?php 
				...
				<table class="table table-striped">
					...
					<tbody>
						 <?php 
							...
							//	echo "<td>
							//		<span class='glyphicon glyphicon-globe' style='".$color."'></span>
							//		</td>";
